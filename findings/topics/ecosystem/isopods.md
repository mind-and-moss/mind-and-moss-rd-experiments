# Isopods — Wild-caught Setup, Quarantine, Compatibility

Cross-cutting research on isopods as cleanup crew and as a starter colony. Bioactive ecosystem context lives in `bioactive-systems.md`.
