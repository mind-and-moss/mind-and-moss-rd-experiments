...
- **Norland Products** — optical-grade UV-cure adhesives (NOA series). Used in optical/photonics manufacturing for refractive-index-matched bonding. Their datasheets list refractive index, viscosity, cure time, and long-term yellowing data — exactly the specs the Gem build needs.
...
- [ ] Norland NOA-XX product comparison chart (which exact adhesive matches the Gem's bond-line and refractive-index requirements)
